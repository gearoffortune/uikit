...
export const ItemDisabled: Story<MenuProps> = (args) => (
    <Menu {...args}>
        <Menu.Item>First</Menu.Item>
        <Menu.Item disabled>Second (disabled)</Menu.Item>
        <Menu.Item>Third</Menu.Item>
    </Menu>
);
...
export const Group: Story<MenuProps> = (args) => (
    <Menu {...args}>
        <Menu.Item>First</Menu.Item>
        <Menu.Group label="First Group">
            <Menu.Item>One</Menu.Item>
            <Menu.Item>Two</Menu.Item>
        </Menu.Group>
        <Menu.Group label="Second Group">
            <Menu.Item>One</Menu.Item>
            <Menu.Item>Two</Menu.Item>
        </Menu.Group>
        <Menu.Item>In the middle</Menu.Item>
        <Menu.Group label="Third Group">
            <Menu.Item>One</Menu.Item>
            <Menu.Item>Two</Menu.Item>
        </Menu.Group>
